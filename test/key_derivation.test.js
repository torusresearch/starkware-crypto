...
describe("Key derivation", () => {
  it("should derive key from mnemonic and eth-address correctly", () => {
    ...
    expect(keyPair.getPrivate("hex")).toBe("06cf0a8bf113352eb863157a45c5e5567abb34f8d32cddafd2c22aa803f4892c");

    index = 7;
    path = getAccountPath(layer, application, ethAddress, index);
    keyPair = getKeyPairFromPath(mnemonic, path);
    expect(keyPair.getPrivate("hex")).toBe("0341751bdc42841da35ab74d13a1372c1f0250617e8a2ef96034d9f46e6847af");

    index = 598;
    path = getAccountPath(layer, application, ethAddress, index);
    keyPair = getKeyPairFromPath(mnemonic, path);
    expect(keyPair.getPrivate("hex")).toBe("041a4d591a868353d28b7947eb132aa4d00c4a022743689ffd20a3628d6ca28c");
  });
});
...
describe("Key grinding", () => {
  it("should produce the correct ground key", () => {
    ...
    expect(grindKey(privateKey, StarkExEc)).toBe("5c8c8683596c732541a59e03007b2d30dbbbb873556fe65b5fb63c16688f941");
  });
});
